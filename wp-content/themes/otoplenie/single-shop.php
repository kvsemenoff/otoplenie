<?php get_header(); ?>
  <div id="main" class="sing">
    ...
    <div class="org_info_dop">
        ...
        <?php if (get_org_address() !="") { ?><div class="org_address"><span class="org_address_content">Адрес (-а): <?php echo get_org_address(); ?></span></div><?php }; ?>
        <div class="org_meto"><?php get_org_metro(); ?></div>
    </div>    
    </div>
    <h3>Режим работы</h3>
    <div class="org_hours"><?php org_hours(); ?></div>
    <h3>Схема проезда</h3>
    <div class="org_map"><?php get_org_map_single(); ?></div>
    <h3>Товарные категории</h3>
    <div class="org_categories"><?php get_org_product_categories(); ?></div>
    <div class="clear"></div>
